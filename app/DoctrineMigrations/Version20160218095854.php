 ...
 */
class Version20160218095854 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__post AS SELECT id, author_id, title, body, createdAt FROM post');
        ...
        $this->addSql('INSERT INTO post (id, author_id, title, body, createdAt) SELECT id, author_id, title, body, createdAt FROM __temp__post');
